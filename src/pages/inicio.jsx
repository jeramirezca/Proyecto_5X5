...
const obtenerVentas = async (setVentas, setEjecutarConsulta) => {
  const options = {
    method: 'GET', url: 'https://limitless-wildwood-65072.herokuapp.com/ventas/', headers: {
...
function Inicio() {
  ...
  const [creada, setCreada] = useState(0);  
  ...
  return (
    <div className="inicio" >
      ...
      <div className="inicio">
        ...
        <CajaInicio nombre="Órdenes de Venta Creadas" icono={icon_pedido} dato={`${creada}`} />         
      </div>
      <div className="inicio">    
