...
const obtenerVentas = async (setVentas, setEjecutarConsulta) => {
  const options = { method: 'GET', url: 'https://limitless-wildwood-65072.herokuapp.com/ventas/', headers: {
  ...
  return (
    <form>
      ...
      <div className="mt-20 prueba2">
        ...
        <input name="vendedor" type="text" placeholder={venta.vendedor.name} disabled className="form-control" />
      </div>
      <div className="mt-20 prueba2">
      ...
      <div className="boton-side totalVenta">
        <label className="semi-bold label-form color-label"> TOTAL VENTA:</label>
