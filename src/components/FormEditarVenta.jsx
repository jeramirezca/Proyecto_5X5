      ...
      <div className="max-width">
        ...
        <form ref={form} onSubmit={submitFormulario} className="table-top">
          ...
          <div className="boton-side totalVenta">
            ...
            $ <input name="totalVenta" className="form-control width-m" type="text" value={infoNuevoVenta.totalVenta}
                ...
                <tr key={nanoid()}>
                  ...
                  <td>
                    <label htmlFor={`cantidad_${index}`}>
                      <input value={fila.cantidad} min="1" className="campoEdicion width-s" type="number" name={`cantidad_${index}`} onChange={e => {
                        let prueba = (e.target.value * fila.valorUnitario);
                      }} />
                    </label>
                  </td>
                  ...
                  <td>
                    <label htmlFor={`totalProducto_${index}`}>
                      $<input value={fila.totalProducto} className="campoEdicion width-s" type="number" name={`totalProducto_${index}`} />
                    </label>
                  </td>
                  <td>
