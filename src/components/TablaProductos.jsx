...
const TablaProductos = () => {
    return (
        ...
        <div className="max-width">
          <h1 className="color-label">Listado de Productos</h1>        
            ...
            <table className="stickytable table">
              ...
              {productosBackend.map((producto) => {
                ...
                <tr>
                  ...
                  <td>
                    <a className="apuntador" onClick={(e) =>window.confirm("Esta seguro que desea eliminar el <objeto>?")}>
                        <svg
                            className ="icon-s" 
                            height="427pt" 
